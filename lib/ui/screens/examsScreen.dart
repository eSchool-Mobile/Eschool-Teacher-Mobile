                  ...
                  children: [
                    Expanded(
                      child: _buildTitleValueContainer(
                          ...
                          value: Utils()
                              .cleanClassName(offlineExam.className ?? "-")),
                    ),
                    SizedBox(
                    ...
                    children: [
                      ListTile(
                        title: CustomTextContainer(
                          textKey:
                              timetableSlot.subject?.getSybjectNameWithType() ??
                                  "-",
                          style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            CustomTextContainer(
                              textKey: totalMarksKey,
                              style: TextStyle(
                                  fontSize:
                                      Utils.getScaledValue(context, 13.5)),
                            ),
                            CustomTextContainer(
